...
namespace seal
{
    ...
    void EncryptionParameters::save_members(ostream &stream) const
    {
        ...
        try
        {
            ...
            uint64_t n_special_primes64 = static_cast<uint64_t>(n_special_primes_);//Chao test added by wenjie lu
            ...
            stream.write(reinterpret_cast<const char*>(&n_special_primes64), sizeof(uint64_t));//Chao test added by wenjie lu
