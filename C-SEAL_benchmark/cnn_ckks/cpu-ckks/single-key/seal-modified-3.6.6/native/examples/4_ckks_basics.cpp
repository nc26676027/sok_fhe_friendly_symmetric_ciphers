...
void example_ckks_basics()
{
    ...
    */
    ...
    parms.set_n_special_primes(5);
    cout <<"after set prime"<<endl;
    auto mudulus = CoeffModulus::Create(poly_modulus_degree, { 50, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 50, 50, 50, 50, 50 });
    cout << "after create modulus"<<endl;
    parms.set_coeff_modulus(mudulus);
    cout <<"after set modulus"<<endl;
    ...
    */
    ...
    seal::sec_level_type sec = seal::sec_level_type::none;
    ...
    // print_parameters(context);
    // cout << endl;
    cout <<"after create context"<<endl;
    ...
    cout << "Evaluating polynomial PI*x^3 + 0.4x + 1 ...niuzi fucj" << endl;
    ...
    */
    ...
    evaluator.relinearize_inplace(x3_encrypted, relin_keys);// first loop, multiply curr_level=11
    ...
    */
    ...
    evaluator.relinearize_inplace(x3_encrypted, relin_keys);//loop 2, curr_level 10
