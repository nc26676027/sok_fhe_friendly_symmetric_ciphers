...
struct {  // SEAL and bootstrapping setting
    long boundary_K = 14; // \approx 1.81 \sqrt(h), e.g. [ 14 \approx 1.81 \sqrt(64) ]
    long boot_deg = 59;
    long scale_factor = 2;
    long inverse_deg = 1; 
    long logN = 16;
    ...
    size_t secret_key_hamming_weight = 64;
    size_t slot_count;
} SEAL_context_params;
...
int main() {
	...
	GIFT_ENC tester(sk, remaining_level, loge, logn, logN - 1, total_level, scale, boundary_K, boot_deg, scale_factor, inverse_deg,
