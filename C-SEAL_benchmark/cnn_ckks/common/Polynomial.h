...
namespace boot
{
	...
	public:
		...
		void homomorphic_poly_evaluation_binary(SEALContext &context, CKKSEncoder &encoder, Encryptor &encryptor, Evaluator &evaluator, RelinKeys &relin_keys, Ciphertext &rtn, Ciphertext &cipher, Decryptor &decryptor);
