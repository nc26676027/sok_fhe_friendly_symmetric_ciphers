...
//	RR getmaxerr(vector<RR> &coeff, long deg, RR start, RR end, int type, RR scale, long prec, long num);
...
//	RR getmaxerr(RR* coeff, long deg, RR start, RR end, int type, RR scale, long prec, long num);
//	RR find_extreme(RR (*func)(RR), Point* &ext, int &ext_count, RR* coeff, long deg, RR start, RR end, long prec, RR scan, int type, RR scale);
