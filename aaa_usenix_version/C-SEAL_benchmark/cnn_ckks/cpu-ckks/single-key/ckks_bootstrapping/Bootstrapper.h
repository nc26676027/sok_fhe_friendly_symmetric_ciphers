...
public:
	...
	Bootstrapper(long _loge, long _logn, long _logNh, long _L, double _final_scale, long _boundary_K, long _sin_cos_deg, long _scale_factor, long _inverse_deg,
    ...
    void bsgs_linear_transform(Ciphertext &rtncipher, Ciphertext &cipher, int totlen, int basicstep, int coeff_logn, const vector<vector<complex<double>>> &fftcoeff);
    void rotated_bsgs_linear_transform(Ciphertext &rtncipher, Ciphertext &cipher, int totlen, int basicstep, int coeff_logn, const vector<vector<complex<double>>> &fftcoeff);
    ...
    void bsgs_linear_transform_hoisting(Ciphertext &rtncipher, Ciphertext &cipher, int totlen, int basicstep, int coeff_logn, vector<vector<complex<double>>> fftcoeff);
    void rotated_bsgs_linear_transform_hoisting(Ciphertext &rtncipher, Ciphertext &cipher, int totlen, int basicstep, int coeff_logn, vector<vector<complex<double>>> fftcoeff);
	...
	// Chao add slim BTS
	void slim_modraise_inplace(Ciphertext &cipher);
	void slim_sfl_full_3(Ciphertext &rtncipher, Ciphertext &cipher);
	void slim_sflinv_full_3(Ciphertext &rtncipher, Ciphertext &cipher);
	void slim_sfl_3(Ciphertext &rtncipher, Ciphertext &cipher);

	void ScaleDown(Ciphertext &rtncipher, Ciphertext &cipher);
	void slim_bootstrap_inplace(Ciphertext &cipher);
	void slim_bootstrap(Ciphertext &rtncipher, Ciphertext &cipher);
	void slim_bootstrap_sparse(Ciphertext &rtncipher, Ciphertext &cipher);
	void slim_bootstrap_full_real_3(Ciphertext &rtncipher, Ciphertext &cipher);

	void slim_coefftoslot_full(Ciphertext &rtncipher, Ciphertext &cipher);
	void slim_slottocoeff_full(Ciphertext &rtncipher, Ciphertext &cipher);
	void slim_slottocoeff(Ciphertext &rtncipher, Ciphertext &cipher);

	void btsDebugPrint(Ciphertext rtncipher, string str);
